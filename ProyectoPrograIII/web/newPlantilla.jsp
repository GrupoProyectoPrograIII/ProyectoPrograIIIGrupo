<%-- 
    Document   : newPlantilla
    Created on : May 11, 2021, 11:11:11 PM
    Author     : family.user
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="controllerModulo?accion=read">Modulos</a></li>
                            <li><a class="dropdown-item" href="controllerPermiso?accion=read">Permisos</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="NewControlador?menu=rol&accion=listar" target="myFrame">Roles</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="controllerUsuario?accion=read">Usuarios</a></li>
                        </ul>
                    </li>                    
                </ul>
                <div class="dropdown">
