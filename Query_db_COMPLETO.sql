...
INSERT INTO MODULO(ID_MODULO,NOMBRE,DESCRIPCION,PATH,NIVEL,ORDEN,ID_MODULO_PADRE) 
  VALUES (1,'MANTENIMIENTOS','MODULO DE MANTENIMIENTOS','/MANTENIMIENTOS',1,1,0),
  (2,'PROCESOS','MODULO DE PROCESOS','/PROCESOS',1,2,0),
  (3,'PEDIDOS','MODULO DE PEDIDOS','/PEDIDOS',1,3,0),
  (4,'REPORTES','MODULO DE REPORTES','/REPORTES',1,4,0),
  (5,'SEGURIDAD','MODULO DE SEGURIDAD','/SEGURIDAD',1,5,0),
  (6,'MODULOS','MODULO DE MODULOS','/MODULOS',2,1,5),
  (7,'PERMISOS','MODULO DE PERMISOS','/PERMISOS',2,2,5),
  (8,'ROLES','MODULO DE ROLES','/ROLES',2,3,5),
  (9,'USUARIOS','MODULO DE USUARIOS','/USUARIOS',2,4,5),
  (10,'AREAS','MODULO DE AREAS','/AREAS',2,1,1),
  (11,'CLIENTES','MODULO DE CLIENTES','/CLIENTES',2,2,1),
  (12,'MESA','MODULO DE MESA','/MESA',2,3,1),
  (13,'MONITOR','MODULO DE MONITOR','/MONITOR',2,4,1),
  (14,'PRODUCTO COMBINADO','MODULO DE PRODUCTO COMBINADO','/PRODUCTO COMBINADO',2,5,1),
  (15,'PRODUCTOS','MODULO DE PRODUCTOS','/PRODUCTOS',2,6,1),
  (16,'PROVEEDORES','MODULO DE PROVEEDORES','/PROVEEDORES',2,7,1),
  (17,'TIPO PRODUCTO','MODULO DE PRODUCTO','/PRODUCTO',2,8,1),
  (18,'DESCARGA INVENTARIO','MODULO DE DESCARGA INVENTARIO','/DESCARGA INVENTARIO',2,1,2),
  (19,'FACTURAS AL CREDITO','MODULO DE FACTURAS AL CREDITO','/FACTURAS AL CREDITO',2,2,2),
  (20,'PAGO DE PEDIDO','MODULO DE PAGO DE PEDIDO','/PAGO DE PEDIDO',2,3,2),
  (21,'CAJA INVENTARIO','MODULO DE CAJA INVENTARIO','/CAJA INVENTARIO',2,4,2),
  (22,'CORTE DE CAJA','MODULO DE CORTE DE CAJA','/CORTE DE CAJA',2,5,2),
  (23,'SELECCIONAR MESA','MODULO DE SELECCIONAR MESA','/SELECCIONAR MESA',2,1,3),
  (24,'ANULAR','MODULO DE ANULAR','/ANULAR',2,2,3),
  (25,'ELEGIR MONITOR','MODULO DE ELEGIR MONITOR','/ELEGIR MONITOR',2,3,3),
  (26,'INVENTARIO GENERAL','MODULO DE INVENTARIO GENERAL','/INVENTARIO GENERAL',2,1,4),
  (27,'INVENTARIO PARCIAL','MODULO DE INVENTARIO PARCIAL','/INVENTARIO PARCIAL',2,2,4),
  (28,'CIERRE','MODULO DE CIERRE','/CIERRE',2,3,4),
  (29,'MONITOR DE CAJA','MODULO DE MONITOR DE CAJA','/MONITOR DE CAJA',2,4,4);
  GO
...
VALUES(1,'Administracion','Rol para administracion del sistema'),
(2,'Gerencia','Rol para gerentes del sistema'),
(3,'Empleados','Rol para empleados del sistema')
GO
...
INSERT INTO PERMISO(ID_PERMISO,ID_MODULO,ID_ROL)  VALUES
	(1,1,1),
	(2,2,1),
	(3,3,1),
	(4,4,1),
...
INSERT INTO [dbo].[PRODUCTO_COMBO]
           ([ID_COMBO]
           ,[ID_TIPO_COMBO]
           ,[DESCRIPCION]
           ,[PRECIO]
           ,[ESTADO])
     VALUES
           (1,0,'CAFE AMERICANO+PAN INTEGRAL',21.00,1),
		   (2,2,'CAFE AMERICANO+CHICHARRON CRIOLLO',32.00,1),
		   (3,0,'PAN INTEGRAL+PAN INTEGRAL',10.00,1),
		   (4,0,'CHICHARRON CRIOLLO+CHICHARRON CRIOLLO',21.00,1)
GO
...
INSERT INTO PROVEEDOR (ID_PROVEEDOR,NOMBRE_PROVEEDOR,TELEFONO,DIRECCION) 
VALUES(1,'PROCASA','22001212','ZONA 4'),
(2,'METAMERCADO','10102020','ZONA 5'),
(3,'PEPSI CO','21212920','ZONA 6');
...
IF exists (SELECT * FROM sys.objects WHERE name = 'DESPACHO' and type = 'u')
	DROP TABLE DESPACHO
GO
